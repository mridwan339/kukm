<!-- Right side column. Contains the navbar and content of the page -->
	<aside class="right-side">
		...
		<section class="content">
			...
			<h3>
                  <p></p>
                <small>Silahkan pilih kategori !</small>
			</h3>
			<div style="border-bottom: 1px solid #eee; margin-bottom:10px;"></div>
			<div class="row">
				<?php 
				foreach($dataKategori['data'] as $item){
				$numRan=rand(0,13);
				?>
				<div class="col-lg-12 col-xs-12">
					<div class="small-box bg-<?php echo jarvis_color_bar($numRan);?>">
						<div class="inner"><h4><?php echo $item['parameter'];?></h4></div>
						<div class="icon"><i style="font-size:50px;" class="ion ion-ios7-filing"></i></div>
						<a class="small-box-footer" href="<?php echo base_url('kategori/'.$year.'/'.jarvis_encode($item['id']));?>"><i class="fa fa-arrow-circle-right"></i></a>
					</div>
				</div>
				<?php } ?>
			</div>			
