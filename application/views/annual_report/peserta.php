								...
								<?php 
									foreach($dataPeserta->result_array() as $item){
										...
										<tr>
											...
											<td style="padding:4px; vertical-align:middle;"><a href="<?php echo base_url('peserta/'.$year.'/'.uri_segment(3).'/'.uri_segment(4).'/'.jarvis_encode($item['id']).'/detail');?>"><?php echo $item['nama'];?></a></td>
